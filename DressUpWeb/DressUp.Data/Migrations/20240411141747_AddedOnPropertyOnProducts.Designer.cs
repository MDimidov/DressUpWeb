...
namespace DressUp.Data.Migrations
{
    ...
    [Migration("20240411141747_AddedOnPropertyOnProducts")]
    partial class AddedOnPropertyOnProducts
    {
            ...
            modelBuilder.Entity("DressUp.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "648a643c-7dad-4cdd-a3c1-e9d51c63fccf",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEPEM89ceBfv/scsoVvBFC2X7Aj7MUvQbidp1qatAHEIN3HyxMGTbgXsD+eyF2+VGmA==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f9311b1f-57b0-4994-8946-90761f64ac5d",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEFPGAqCHZ0/LE8+dGd/0VjXju7mf3h9BnzRJtxJ2SUifYuESM6RNZWchJDr6WS9P7A==",
                            PhoneNumberConfirmed = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1893de59-616a-4ec5-927d-23ca1195c60f",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEKF/ZkhirdXwa1XSvS7mikwbYwixA6LBQA1yO0edJn3tKMnhB5Ag3/6Z81kGroh5Pg==",
                            PhoneNumberConfirmed = false,
            ...
            modelBuilder.Entity("DressUp.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AddedOn = new DateTime(2024, 4, 11, 14, 17, 47, 28, DateTimeKind.Utc).AddTicks(9476),
                            BrandId = 1,
                            CategoryId = 1,
                        ...
                        {
                            Id = 2,
                            AddedOn = new DateTime(2024, 4, 11, 14, 17, 47, 28, DateTimeKind.Utc).AddTicks(9669),
                            BrandId = 2,
                            CategoryId = 2,
                        ...
                        {
                            Id = 3,
                            AddedOn = new DateTime(2024, 4, 11, 14, 17, 47, 28, DateTimeKind.Utc).AddTicks(9732),
                            BrandId = 3,
                            CategoryId = 1,
                        ...
                        {
                            Id = 4,
                            AddedOn = new DateTime(2024, 4, 11, 14, 17, 47, 28, DateTimeKind.Utc).AddTicks(9788),
                            BrandId = 4,
                            CategoryId = 3,
                        ...
                        {
                            Id = 5,
                            AddedOn = new DateTime(2024, 4, 11, 14, 17, 47, 28, DateTimeKind.Utc).AddTicks(9842),
                            BrandId = 5,
                            CategoryId = 4,
                        ...
                        {
                            Id = 6,
                            AddedOn = new DateTime(2024, 4, 11, 14, 17, 47, 28, DateTimeKind.Utc).AddTicks(9905),
                            BrandId = 1,
                            CategoryId = 1,
                        ...
                        {
                            Id = 7,
                            AddedOn = new DateTime(2024, 4, 11, 14, 17, 47, 28, DateTimeKind.Utc).AddTicks(9963),
                            BrandId = 2,
                            CategoryId = 2,
                        ...
                        {
                            Id = 8,
                            AddedOn = new DateTime(2024, 4, 11, 14, 17, 47, 29, DateTimeKind.Utc).AddTicks(58),
                            BrandId = 3,
                            CategoryId = 3,
                        ...
                        {
                            Id = 9,
                            AddedOn = new DateTime(2024, 4, 11, 14, 17, 47, 29, DateTimeKind.Utc).AddTicks(111),
                            BrandId = 4,
                            CategoryId = 1,
                        ...
                        {
                            Id = 10,
                            AddedOn = new DateTime(2024, 4, 11, 14, 17, 47, 29, DateTimeKind.Utc).AddTicks(164),
                            BrandId = 5,
                            CategoryId = 4,
            ...
            modelBuilder.Entity("DressUp.Data.Models.Store", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClosingTime = new DateTime(2024, 4, 11, 21, 0, 0, 0, DateTimeKind.Unspecified),
                            ContactInfo = "123-456-7890",
                            ImageUrl = "~/DressPics/Stores/FIola.jpg",
                            Name = "Fiolla Asparuhovo",
                            OpeningTime = new DateTime(2024, 4, 11, 9, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            AddressId = new Guid("8a0d518b-9d8a-4e80-a68b-5b2f89b14812"),
                            ClosingTime = new DateTime(2024, 4, 11, 20, 0, 0, 0, DateTimeKind.Unspecified),
                            ContactInfo = "987-654-3210",
                            ImageUrl = "~/DressPics/Stores/Fiola2.webp",
                            Name = "Fiolla Izgrev",
                            OpeningTime = new DateTime(2024, 4, 11, 10, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 3,
                            AddressId = new Guid("fbd8adbb-9de2-4e63-b8fc-32a01b6ed348"),
                            ClosingTime = new DateTime(2024, 4, 11, 18, 0, 0, 0, DateTimeKind.Unspecified),
