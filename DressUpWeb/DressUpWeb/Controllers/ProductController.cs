...
public class ProductController : BaseController
{
    ...
    public async Task<IActionResult> Add(ProductFormModel formModel, IEnumerable<IFormFile> files)
    {
        ...
        {       
            ...
            IEnumerable<string> uploadedImgsUrls;
            if (files != null)
            {
                uploadedImgsUrls = productService.UploadImages(files, formModel.SizeType);
                foreach(string imgUrl  in uploadedImgsUrls)
                {
    ...
    public IActionResult AddImage(List<IFormFile> files)
    {
        ...
        if (files != null)
        {
            uploadedImgsUrls = productService.UploadImages(files, DressUp.Data.Models.Enums.SizeType.Child);
        }
